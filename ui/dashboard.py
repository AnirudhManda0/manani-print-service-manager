"""Dashboard KPI cards for PrintX."""

from ui.qt import QFrame, QGridLayout, QLabel, QSizePolicy, QVBoxLayout, QWidget, Qt

from ui.formatting import format_currency


class StatCard(QFrame):
    """Reusable compact card widget used for each dashboard metric."""
...
class DashboardPanel(QWidget):
    """Top summary panel for daily PrintX KPI totals."""
    ...
    def __init__(self) -> None:
        ...
        self.total_services = StatCard("Total Services", accent="green")

        layout.addWidget(self.total_revenue, 0, 0)
        layout.addWidget(self.total_prints, 0, 1)
        layout.addWidget(self.bw_pages, 0, 2)
        layout.addWidget(self.color_pages, 0, 3)
        layout.addWidget(self.total_services, 0, 4)
